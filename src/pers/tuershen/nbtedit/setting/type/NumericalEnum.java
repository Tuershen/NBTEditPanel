...
public enum NumericalEnum implements NumericalConversion {
    ...
    INT {
        @Override public Number conversion(String data) {
    ...
    LONG {@Override public Number conversion(String data) {
        return Long.parseLong(data);
    }},

    DOUBLE{@Override public Number conversion(String data) {
